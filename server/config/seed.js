...
Item.find({}).remove(function() {
    Item.create({
        ...
        sports: ["test1, test2, test3, test4"],
        arts: ["testArts1, testArts2, testArts3"],
        clubs: ["testClub1, testClub2, testClub3, testClub4"],
        website: "www.aop.net",
        gradeLevels: "6 - 12",
        enrollment: "143",
        boarding: "Day Only",
